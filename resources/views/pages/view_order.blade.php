    ...
    <div class="row">
      <div class="col-12">
        <div class="your-order py-5 my-5">
          <h1 class="display-3 text-center">Your order details</h1>
          ...
          <div class="order-button-payment">
            <a href="{{ url('account') }}" class="btn btn-lg btn-block btn-dark py-3"><span class="arrow_back"></span> Back to your Account</a>
          </div>
		  </div>
    </div>
  </div>
